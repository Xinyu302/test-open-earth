...
module {
  func @hadvuv(%arg0: !stencil.field<?x?x?xf64>, %arg1: !stencil.field<?x?x?xf64>, %arg2: !stencil.field<?x?x?xf64>, %arg3: !stencil.field<?x?x?xf64>, %arg4: !stencil.field<0x?x0xf64>, %arg5: !stencil.field<0x?x0xf64>, %arg6: !stencil.field<0x?x0xf64>, %arg7: !stencil.field<0x?x0xf64>) attributes {stencil.program} {
    ...
    %17 = stencil.apply (%arg8 = %8 : !stencil.temp<?x?x?xf64>, %arg9 = %14#1 : !stencil.temp<?x?x?xf64>, %arg10 = %15#1 : !stencil.temp<?x?x?xf64>, %arg11 = %15#0 : !stencil.temp<?x?x?xf64>, %arg12 = %12 : !stencil.temp<0x?x0xf64>) -> !stencil.temp<?x?x?xf64>{
      ...
      // %92 = stencil.access %arg9 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      // %92 = %24
      %93 = stencil.access %arg11 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      %94 = stencil.access %arg12 [0, 0, 0] : (!stencil.temp<0x?x0xf64>) -> f64
      // %95 = stencil.access %arg8 [0, 0, 0] : (!stencil.temp<?x?x?xf64>) -> f64
      // %95 = %68
      %96 = mulf %24, %93 : f64
      %97 = mulf %96, %94 : f64
      %98 = addf %97, %68 : f64
      %99 = stencil.store_result %98 : (f64) -> !stencil.result<f64>
      stencil.return %99 : !stencil.result<f64>
    }
